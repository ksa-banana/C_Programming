## 2020 혁신성장 청년인재 인공지능(AI) 전문가 집중양성: C Programming
<h4>[장소] KSA 한국표준협회</h4>
...
<ul>
 ...
 <ul>
    ...
    <li><h5>역할 분담</h5></li>
    <ul>
      <li><h5>강나래: 프로젝트 설계, 데이터 버블 정렬 함수 구현, 정렬 선택 함수 구현, 메인 코드 파일 & 기능 코드 파일 & 헤더 파일로 각각 분리  </h5></li>
      <li><h5>김주연: 프로젝트 설계, 데이터 입력 함수 구현, 구현한 함수들의 플로우차트 작성, 프로젝트 문서화</h5></li>
      <li><h5>임성환: 프로젝트 설계, 파일 쓰기 함수 구현, 파일 읽기 함수 구현, 구현한 함수들의 플로우차트 작성</h5></li>
      <li><h5>정주비: 프로젝트 설계, 정렬 선택 함수 구현, 출력 함수 구현, 구현한 함수들의 플로우차트 작성</h5></li>
    </ul>
